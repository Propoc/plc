    ...
    return (
        <div className={`w-full h-screen ${c2}`}>
            ...
            >
                ...
                <div className={`h-full flex-[2] flex items-center justify-center border-l-4 border-black`}>
                Proje No
                </div>
                <div className={`h-full flex-[2] flex items-center justify-center border-l-4 border-black`}>
                Cihaz No
            ...
            <div
                key={idx}
                className={`w-full h-12 ${c2} flex items-center mb-4 border-black border-2 text-2xl cursor-pointer`}
                onClick={() => {
                    setSelectedProject(p);
                    setPage("dashboard");
                }}
            >
                <div className={`w-full h-full flex-[3] flex items-center justify-center text-black`}>
                {p.name}
                </div>
                <div className={`w-full h-full flex-[2] flex items-center justify-center text-black border-l-2 border-black`}>
                {p.projectNo}
                </div>
                <div className={`w-full h-full flex-[2] flex items-center justify-center text-black border-l-2 border-black`}>
                {p.deviceNo}
                </div>
                <div className={`w-full h-full flex-[1] flex items-center justify-center text-black border-l-2 border-black`}>
                {p.ahuNo}
                </div>
                <div className={`w-full h-full flex-[2] flex items-center justify-center text-black border-l-2 border-black`}>
                {p.topic}
